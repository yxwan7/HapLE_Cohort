...
/***(1) All programs */
  ...
  %LET BEG=86;                  /*** First age of the life table.*/
  %LET AgeLowerLimit=83;                  /*** The lowest age from the input data. Range from 0 to BEG*/
...
/***(2) RAD program (module 1) only */
  %LET END_LT= 91 ;            /*** Last age (open interval) the life table.*/
