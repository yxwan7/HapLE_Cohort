...
/***(1) All programs */
  ...
  %LET REGCOV= cohort urban;               /*** Covariate(s) in regression models. */
  ...
  %LET InteractionTerm = age*sex age*cohort cohort*sex cohort*urban urban*sex age*urban  ;   /*** User defined interaction terms. Default is blank.              ***/
                                                            /*** For example:                                                   ***/
                                                            /***              Age*Sex                                           ***/
