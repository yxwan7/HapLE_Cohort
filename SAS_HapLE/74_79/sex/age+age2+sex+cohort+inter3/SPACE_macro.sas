...
/***(1) All programs */
  %LET BSIZE=300;                 /*** # of bootstrap samples. At least 0. It has to be a positive integer >= 2.*/
  %LET BEG=74;                  /*** First age of the life table.*/
  %LET AgeLowerLimit=71;                  /*** The lowest age from the input data. Range from 0 to BEG*/
  ...
  %LET InteractionTerm = age*sex age*cohort cohort*sex  ;   /*** User defined interaction terms. Default is blank.              ***/
                                                            /*** For example:                                                   ***/
                                                            /***              Age*Sex                                           ***/
