...
# All
file_68_73_all <- "../SAS_HapLE_4s/Output/LE/sex_all/LE_68_73_sex_all_4s_r.txt"
file_74_79_all <- "../SAS_HapLE_4s/Output/LE/sex_all/LE_74_79_sex_all_4s_r.txt"
file_80_85_all <- "../SAS_HapLE_4s/Output/LE/sex_all/LE_80_85_sex_all_4s_r.txt"
file_86_91_all <- "../SAS_HapLE_4s/Output/LE/sex_all/LE_86_91_sex_all_4s_r.txt"
...
# Men and Women
file_68_73 <- "../SAS_HapLE_4s/Output/LE/sex/LE_68_73_sex_4s_r.txt"
file_74_79 <- "../SAS_HapLE_4s/Output/LE/sex/LE_74_79_sex_4s_r.txt"
file_80_85 <- "../SAS_HapLE_4s/Output/LE/sex/LE_80_85_sex_4s_r.txt"
file_86_91 <- "../SAS_HapLE_4s/Output/LE/sex/LE_86_91_sex_4s_r.txt"
...
# Export HTML tables
filename_les_html <- "R output/1_2_life_expectancy_sex_4s.html"

save_kable(table_les_kable, file = filename_les_html, self_contained = TRUE)

# Export LaTeX tables
filename_les_latex <- "R output/1_2_life_expectancy_sex_4s.tex"

save_kable(table_les_latex, file = filename_les_latex)

# Export underlying data frames to CSV
write.csv(combined_results_les, "R output/1_2_life_expectancy_sex_4s.csv", row.names = FALSE)
